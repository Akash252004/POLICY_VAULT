        ...
        <div className="md:hidden absolute top-full left-0 right-0 bg-white shadow-lg animate-fade-in">
          <div className="container mx-auto px-4 py-4 flex flex-col space-y-4">
            ...
            <Link to="/login" className="w-full" onClick={closeMenu}>
              <Button className="bg-insurance-600 hover:bg-insurance-700 text-white w-full mb-2">
                Login
              </Button>
            </Link>
            <Link to="/signup" className="w-full" onClick={closeMenu}>
              <Button variant="outline" className="border-insurance-600 text-insurance-600 hover:bg-insurance-50 w-full">
                Sign Up
              </Button>
            </Link>
          </div>
