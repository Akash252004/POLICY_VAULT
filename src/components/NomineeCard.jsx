...
const NomineeCard = ({ nominee, onVerify, getPolicyName }) => {
  ...
  return (
    <Card className="overflow-hidden transition-all hover:shadow-md animate-fade-up border-insurance-100">
      <div className="relative">
        <div className="absolute top-0 right-0 bg-insurance-600 text-white text-xs font-semibold px-3 py-1 rounded-bl-md">
        ...
        <div className="p-6">
          <div className="flex items-start justify-between">
            <div className="flex items-center space-x-3">
              <div className="p-2 rounded-full bg-insurance-100">
          ...
          <div className="mt-6 grid grid-cols-1 gap-3 text-sm">
            <div className="flex items-center space-x-2">
              <Mail className="h-4 w-4 text-insurance-400" />
              <div>
            ...
            <div className="flex items-center space-x-2">
              <Phone className="h-4 w-4 text-insurance-400" />
              <div>
            ...
            <div className="flex items-center space-x-2">
              <FileText className="h-4 w-4 text-insurance-400" />
              <div>
          ...
          {!nominee.verified && (
            <div className="mt-4">
              ...
              <Button 
                className="w-full mt-3 bg-insurance-600 hover:bg-insurance-700 text-white shadow-sm"
          ...
          <div className="mt-6 pt-4 border-t border-gray-100">
            <div className="flex justify-between items-center">
              ...
              <button className="text-insurance-600 text-sm font-medium hover:text-insurance-700 hover:underline transition-all">
                Edit Details
              </button>
            </div>
          </div>
