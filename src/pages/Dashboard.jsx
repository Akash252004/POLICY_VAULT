        ...
        <div className="container mx-auto">
          ...
          <section className="mb-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card className="p-6 animate-fade-up shadow-sm border-insurance-100 bg-white">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Policy Values</h3>
                <PolicyBarChart data={barChartData} />
              </Card>
              
              <Card className="p-6 animate-fade-up shadow-sm border-insurance-100 bg-white" style={{ animationDelay: '100ms' }}>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Policy Distribution</h3>
                <p className="text-sm text-gray-500 mb-3">Overview of your insurance policies by category</p>
